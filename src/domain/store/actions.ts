 ...
 * Vue Start Kit
 *
 * Define all the actions from the app store.
 *
 ...
 * is useful if you need to wait for receiving data from an API, for example.
 *
 * An action should dispatch a mutation, which will update the state.
 *
